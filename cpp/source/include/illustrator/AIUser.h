...
#define kAIUserSuiteVersion18		AIAPI_VERSION(18)
#define kAIUserSuiteVersion			kAIUserSuiteVersion18
#define kAIUserVersion				kAIUserSuiteVersion

#if Macintosh || MSWindows
#define kAIMacUserSuite				"AI Mac User Suite"
#define kAIMacUserSuiteVersion8		AIAPI_VERSION(8)
#define kAIMacUserSuiteVersion		kAIMacUserSuiteVersion8
